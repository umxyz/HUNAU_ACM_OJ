<a target="_blank" href="http://hk.mikecrm.com/DMjIlnM" style="position:fixed;z-index:999;right:10px;bottom: 350px;display: inline-block;width: 100px;border-radius: 5px;color:white;font-size:16px;line-height:40px;background: #2476CE;box-shadow: 0 0 5px #666;word-wrap: break-word;padding: 10px 6px;border: 2px solid white;">模拟赛报名</a>
...
<div class="row blog">
    <div class="col-md-8">
	   ...
	   <!-- <font color = FF5757 size = 16 >欢迎来到湖南农业大学</font>
		...
		-->
		<a href="https://mp.weixin.qq.com/s/6dwgJfaiZD8lqbTz-4-_PQ" title="ACM实验室迎新介绍" target="_blank"><font size=12 color=FF5233 >点击查看ACM实验室宣传网页</font></a>
		<br>
        </div>
       <!-- <hr>-->
        <div class="blog-main">
